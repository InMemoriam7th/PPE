...
public class AjoutEmploye {
	...
	private JTextField dateArrivee = new JTextField();
	...
	private JPanel date() {
		JPanel item_frame = item_frame();
		dateArrivee.setMaximumSize(new Dimension(150, 20));
		dateDepart.setMaximumSize(new Dimension(150, 20));
		item_frame.add(dateArrivee_label);
		item_frame.add(dateArrivee);
		item_frame.add(dateDepart_label);
		item_frame.add(dateDepart);
		return item_frame;
	}
