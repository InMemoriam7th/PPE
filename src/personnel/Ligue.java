...
public class Ligue implements Serializable, Comparable<Ligue>
{
	...
	/**
	 * Ajoute un employÈ dans la ligue. Cette mÈthode 
	 * est le seul moyen de crÈer un employ√©.
	 * @param nom le nom de l'employÈ.
	 * @param prenom le prÈnom de l'employÈ.
	 * @param mail l'adresse mail de l'employÈ.
	 * @param password le password de l'employÈ.
	 * @return l'employÈ crÈÈ. 
	 */
